...
/**
 * @SWG\Definition(
 *      definition="TemplateFingerprintDevice",
 *      required={"device_id", "pin", "fid", "size", "valid"},
 *      @SWG\Property(
 *          property="id",
 *          description="id",
 *          type="integer",
 ...
 * )
 */
class TemplateFingerprintDevice extends Model
{
    use HasFactory;
    //     use SoftDeletes;

    public $table = 'template_fingerprint_devices';
